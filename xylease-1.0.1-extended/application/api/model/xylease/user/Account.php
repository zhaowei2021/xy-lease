...
class Account extends Model
{
    ...
    // 表名
    protected $name = 'xylease_user_account';
    ...
    public static function add($params){
        ...
        $accountData['realname'] = $params['realname'];
        $accountData['mobile'] = $params['mobile'];
        $accountData['type'] = $params['type'];
        $accountData['accountname'] = $params['accountname'];
        $accountData['accountno'] = $params['accountno'];
