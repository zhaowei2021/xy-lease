<template>
	<view class="date-tabs-container" :style="{backgroundColor: bgColor,borderRadius:bdRadius}">
		<view class="tabs-wrapper" :style="{width:(!isMore?'100%':'calc(100% - 100rpx)')}">
...
<script>
	...
	export default {
		...
		computed: {
			...
			calendarEndDate() {
				return this.endDate || dayjs(this.calendarStartDate).add(4, 'd').format('YYYY-MM-DD')
			}
		},
		watch: {
